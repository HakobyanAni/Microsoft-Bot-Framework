...
<i>-> Bots can communicate conversationally with text, cards or speech</i><p>
<i>-> Conversation can be designed to be in a free form or to be more guided where users have choices and actions</i><p>
