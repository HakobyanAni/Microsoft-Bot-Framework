...
<h3> What is a bot?</h3>
<i>->	Bots are apps that interact with users in a conversational format</i>
<i>-> Bots can communicate conversationally with text, cards or speech</i>
<i>-> Conversation can be designed to be in a free form or to be more guided where users have choices and actions</i>
