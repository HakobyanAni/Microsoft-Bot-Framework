...
namespace CoreBot
{
    public class CoreBotBot : IBot
    {
        ...
        public const string WeatherCondition = "Weather.GetCondition";
        public const string WeatherForecast = "Weather.GetForecast";

        public static readonly string LuisConfiguration = "checkweatherwithluis";
